...
Progress Bar:
              <ProgressBar 
                striped 
                variant="success"
                now={currentDashboard?.totalTasks && currentDashboard?.completedTasks 
                  ? ((currentDashboard.completedTasks / currentDashboard.totalTasks) * 100) 
                  : 0}
                label={currentDashboard?.totalTasks && currentDashboard?.completedTasks 
                  ? `${Math.round((currentDashboard.completedTasks / currentDashboard.totalTasks) * 100)}%` 
                  : '0%'} 
